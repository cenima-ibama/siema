  ...
  .directive('datas', function () {
    return {
      ...
      controller: function($scope){
        ...
        $scope.datas.subPanel = $scope.oleo ? '(Itens II e III do Anexo II do Decreto n 4.136 de 20 de fevereiro de 2002)' : '';

        // if ($scope.oleo) {
        //     $scope.datas.subPanel = '(Itens II e III do Anexo II do Decreto n 4.136 de 20 de fevereiro de 2002)';
        // } else {
