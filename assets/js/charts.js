...
(function() {
  var Hash5Charts, Hash5GoogleCharts, Hash5Knobs, Hash5Sparks, chart1, chart2, chart3, chart4, chart5, chart6, chart7, chart8, curDay, curMonth, curYear, estados, gauge1, gauge2, gauge3, i, knob1, knob2, knob3, months, monthsOrdered, periodos, reloadCharts, selectedState, spark1, spark2, tableData, today, totalPeriodos, _i,
  ...
  Hash5Knobs = (function(_super) {
    ...
    Hash5Knobs.prototype.createKnob = function() {
      ...
      html += "</div>";
      $(container).append(html);
      return this.insertKnob(container);
    };

    Hash5Knobs.prototype.updateKnob = function(value, name) {
      var container, info;
      container = document.getElementById(this.options.container);
  ...
  Hash5Sparks = (function(_super) {
    ...
    Hash5Sparks.prototype.updateSparkInfo = function(value, name) {
      var container, info;
      container = document.getElementById(this.options.container);
      info = $(container).children(".right");
  ...
  chart2.drawChart = function() {
    var data, month, moth, options, sumValues, _j, _k, _ref, _ref1, _ref2,
      _this = this;
    ...
    for (month in months) {
      ...
      moth = (7 <= (_ref1 = month + 7) && _ref1 <= 11) ? month += 7 : month -= 5;
  ...
  spark1.drawChart = function() {
    ...
    this.updateSparkInfo(value, "Total Mensal");
  ...
  spark2.drawChart = function() {
    ...
    $.each(months, function(number, month) {
      ...
      number = (7 <= (_ref = number + 7) && _ref <= 11) ? number += 7 : number -= 5;
    ...
    this.updateSparkInfo(Math.round(value * 100) / 100, "Total Período");
    return this.updateSparkChart(data);
  };
  ...
  knob1.drawChart = function() {
    ...
    this.updateKnob(value, "Taxa VAA");
  };
  ...
  knob2.drawChart = function() {
    ...
    value = periodDeforestationRate(chart1.yearsSlct.value, chart1.monthsSlct.value);
    this.updateKnob(value, "Taxa VMA");
  };
  ...
  knob3.drawChart = function() {
    ...
    this.updateKnob(value, "Taxa VPA");
  };
