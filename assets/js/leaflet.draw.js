...
L.drawLocal = {
    draw: {
        toolbar: {
            ...
            undo: {
                title: 'Deletar o ultimo ponto desenhado',
                text: 'Deletar o ultimo ponto'
            },
            buttons: {
                polyline: 'Desenhe uma linha',
                polygon: 'Desenhe um polígono',
                rectangle: 'Desenhe um retângulo',
                circle: 'Desenhe um círculo',
        ...
        handlers: {
            ...
            marker: {
                tooltip: {
                    start: 'Clique para adicionar um ponto.'
                }
            },
            polygon: {
                tooltip: {
                    start: 'Clique para começar a desenhar um polígono.',
                    cont: 'Clique para continuar desenhando uma figura.',
                    end: 'Clique no último ponto para fechar a figura.'
                }
            },
            polyline: {
                error: '<strong>Erro:</strong> Figuras não podem se intercalar!',
                tooltip: {
                    start: 'Clique para iniciar o desenho de uma linha.',
            ...
            simpleshape: {
                tooltip: {
                    end: 'Solte o botão do mouse para finalizar o desenho.'
                }
            }
        }
    },
    edit: {
        toolbar: {
            actions: {
                save: {
                    title: 'Excluir desenhos.',
                    text: 'Excluir'
                },
                cancel: {
                    title: 'Cancelar exclusão, descarta todas as exclusões.',
                    text: 'Cancelar'
                }
            },
            buttons: {
        ...
        handlers: {
            edit: {
                tooltip: {
                    text: 'Arraste âncoras ou pontos para editar.',
                    subtext: 'Clique em cancelar para desfazer as mudanças.'
                }
            },
            remove: {
                tooltip: {
                    text: 'Clique numa figura para removê-la.'
                }
            }
        }
    }
...
L.Draw.Marker = L.Draw.Feature.extend({
    ...
    _fireCreatedEvent: function () {
        var marker = new L.Marker(this._mouseMarker.getLatLng(), { icon: this.options.icon });
