...
(function() {
  var consultarOcorrencias, generateConsultCSV, getContentExportConsult, getHeadersColumnsResults, setFilter;
...
>>>>>>> d0c62769cde2005281a4d9cb474caca2d532cd74
  ...
  consultarOcorrencias = function(tpProd, uf, origem, dtIni, dtFim) {
    var dataCadastrada, dataIncidente, diaSemana, headersTable, query, registroTemp, rest;
    ...
    $.each(rest.data, function(index, dt) {
      ...
      return registroTemp[registroTemp.length] = new Array(dt.id_ocorrencia, dataIncidente, dt.municipio, dt.uf, dt.origem, dt.tipo_evento, dt.tipos_danos_identificados, dt.institiuicoes_atuando_local, dt.tipos_fontes_informacoes, diaSemana, dt.periodo_ocorrencia, dt.dt_ocorrencia_feriado);
    });
    ...
    arrayResults = new Array([
      {
        ...
        text: "Ocorrências/Ambientes Atingidos",
        style: "header"
      }, {
        text: "Inst. Atuando no Local",
        style: "header"
      }, {
        text: "Fonte",
        style: "header"
