...
(function() {
  var acidentes, banhado, bingKey, bingMini, bingaerial, binghybrid, bingroad, biomaIBGE, blocoExploratorio, controlswitch, costao, duna, eixoDutoviario, eixoFerroviario, eixoRodoviario, estacaoFerroviaria, estuario, geoserverUrl, hidrografia, iconsURL, lagunas, mangues, marTerritorial, marisma, openmapquest, openmapquestSub, openmapquestUrl, openstreet, openstreetUrl, orientationEvent, ponteTunel, portoTerminal, recifes, refinaria, restURL, restinga, supportsOrientationChange, terrasIndigenas, ucEstadual, ucFederal, ucMunicipal;
