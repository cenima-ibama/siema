...
(function() {
  var chart1, chart2, chart3, chart4, chart5, chart6, chart7, chart8, knob1, knob2, knob3, options, rest, spark1, spark2,
  ...
  chart4.drawChart = function() {
    var allData, countPeriod, data, i, j, period, sumValues, totalReg, _i, _j, _k, _len, _ref, _ref1, _ref2, _results,
      _this = this;
      ...
      if (H5.Data.region === "Todos") {
        $.each(H5.DB.occurence.data.regions, function(region, reg) {
          ...
          for (j = _k = 1, _ref2 = _this.options.period; 1 <= _ref2 ? _k <= _ref2 : _k >= _ref2; j = 1 <= _ref2 ? ++_k : --_k) {
            ...
            _results1.push(data[j] = data[j] >= 0 ? data[j] + totalReg : totalReg);
          }
          return _results1;
        });
      } else {
  ...
  chart5.drawChart = function() {
    var allData, data, i, institution, j, sumValues, totalReg, _i, _j, _k, _len, _ref, _ref1, _ref2, _results,
      _this = this;
  ...
  chart6.drawChart = function() {
    var data, originTitle, source, sumValues, _i, _len, _ref,
      _this = this;
  ...
  chart7.drawChart = function() {
    var data, i, originTitle, region, sumValues, _i, _ref,
      _this = this;
  ...
  chart8.drawChart = function() {
    var data, daysInMonth, firstPeriod, i, originTitle, pieText, pieTooltip, region, secondPeriod, sumValues, _i, _ref;
