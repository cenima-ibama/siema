...
(function() {
  ...
  for (key in _ref3) {
    ...
    if (!reg.legado && reg.validado === 'N') {
      ...
      html += '      <td><a class="editOcorrencia" onclick="openWindow(' + reg.nro_ocorrencia + ')"><i class="icon-edit icon-white"></i></a></td>';
  ...
  openWindow = function(ocorrencia) {
    window.open("//" + document.location.host + document.location.pathname + "stats/#/acidente?id=" + ocorrencia + "&acao=carregar&usuario=" + H5.user + "&email=" + H5.mail + "&validador=true", "_blank", "width=1200,height=800,scrollbars=yes,status=yes,resizable=no");
  };
