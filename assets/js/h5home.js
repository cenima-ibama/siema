...
(function() {
  var consultarOcorrencias, exportCSV, exportPDF, generateConsultCSV, getContentExportConsult, getHeadersColumnsResults, headersTable, setFilter,
    _this = this;
  ...
  */
  ...
  consultarOcorrencias = function(tpProd, uf, origem, dtIni, dtFim, eOceano, baciaSedimentar) {
    var dataCadastrada, dataIncidente, diaSemana, municipioUf, query, registroTemp, rest;
    ...
    municipioUf = "";
    return $.each(rest.data, function(index, dt) {
      ...
      dataIncidente += " ";
      return registroTemp[registroTemp.length] = new Array(dt.id_ocorrencia, dataIncidente, municipioUf, dt.origem, dt.tipo_evento, dt.produtos_onu, dt.produtos_outro, dt.tipos_danos_identificados, dt.institiuicoes_atuando_local, dt.tipos_fontes_informacoes, diaSemana, dt.periodo_ocorrencia, dt.dt_ocorrencia_feriado);
    });
  };
