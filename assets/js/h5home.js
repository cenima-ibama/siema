...
(function() {
  ...
  consultarOcorrencias = function(tpProd, uf, origem, dtIni, dtFim, eOceano, baciaSedimentar) {
    ...
    $.each(rest.data, function(index, dt) {
      ...
      return registroTemp[registroTemp.length] = new Array(dt.id_ocorrencia, dataIncidente, municipioUf, dt.origem, dt.tipo_evento, dt.tipos_danos_identificados, dt.institiuicoes_atuando_local, dt.tipos_fontes_informacoes, diaSemana, dt.periodo_ocorrencia, dt.dt_ocorrencia_feriado);
    });
