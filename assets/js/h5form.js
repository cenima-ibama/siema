...
(function() {
  $(document).ready(function() {
    var Marker, addSelection, bingKey, binghybrid, collapse, date, disabled, history, idOcorrencia, latlng, nroComunicado, rest, seconds, subjects, table, value, _tipoDanoIdentificado, _tipoEvento, _tipoFonteInformacao, _tipoInstituicaoAtuando, _tipoLocalizacao;
