...
(function() {
  ...
  H5.Charts.GoogleCharts = (function(superClass) {
    extend(GoogleCharts, superClass);
    ...
    GoogleCharts.prototype._enableExport = function() {
      ...
      generateCSV = (function(_this) {
        return function() {
          var col, j, k, l, line, ref, ref1, ref2, row, str, title, value;
          str = "";
          line = "";
          for (col = j = 0, ref = _this.data.getNumberOfColumns(); 0 <= ref ? j < ref : j > ref; col = 0 <= ref ? ++j : --j) {
            title = _this.data.getColumnLabel(col);
            line += "\"" + title + "\",";
          }
          str += line + "\r\n";
          for (row = k = 0, ref1 = _this.data.getNumberOfRows(); 0 <= ref1 ? k < ref1 : k > ref1; row = 0 <= ref1 ? ++k : --k) {
            line = "";
            for (col = l = 0, ref2 = _this.data.getNumberOfColumns(); 0 <= ref2 ? l < ref2 : l > ref2; col = 0 <= ref2 ? ++l : --l) {
  ...
  H5.Charts.Knobs = (function(superClass) {
    extend(Knobs, superClass);
  ...
  H5.Charts.Sparks = (function(superClass) {
    extend(Sparks, superClass);
