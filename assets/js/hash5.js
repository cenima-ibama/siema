...
(function() {
  ...
  H5.Charts.Container = (function() {
    ...
    Container.prototype._createContainer = function() {
      var addBtn, addIcon, chartContent, chartHeader, chartTitle, closeBtn, closeIcon, delBtn, delIcon, exportBtn, exportIcon, formBtn, leftBtn, leftCtrl, leftIcon, maxBtn, maxIcon, minBtn, minIcon, pipeline, rightBtn, rightCtrl, rightIcon, tableBtn, tableIcon,
        _this = this;
    ...
    Container.prototype._enableTable = function() {
      var chartTable,
        _this = this;
      chartTable = document.createElement("div");
      chartTable.id = "chart-" + this.options.container;
      chartTable.className = "chart-table";
      this._chartTable = chartTable;
      $(this._container).append(this._chartTable);
      return $(this._exportBtn).on("click", function(event) {
        event.preventDefault();
        return $(_this._chartTable).fadeToggle();
      });
    };
  ...
  H5.Charts.GoogleCharts = (function(_super) {
    ...
    GoogleCharts.prototype._enableExport = function() {
      ...
      generateCSV = function() {
        var col, line, row, str, value, _i, _j, _ref1, _ref2;
        str = "";
        for (row = _i = 0, _ref1 = _this.data.getNumberOfRows(); 0 <= _ref1 ? _i < _ref1 : _i > _ref1; row = 0 <= _ref1 ? ++_i : --_i) {
          line = "";
          for (col = _j = 0, _ref2 = _this.data.getNumberOfColumns(); 0 <= _ref2 ? _j < _ref2 : _j > _ref2; col = 0 <= _ref2 ? ++_j : --_j) {
            value = String(_this.data.getFormattedValue(row, col));
            line += "\"" + value + "\",";
          }
          line = line.slice(0, -1);
          str += line + "\r\n";
