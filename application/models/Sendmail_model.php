...
class Sendmail_model extends CI_Model {
  ...
  public function getEmailBody($profile, $protocol_number, $hour, $date) {
    /* Profiles:
    ...
    */
    ...
    if($profile == 0) {
      ...
      $firstFrase = $firstFrase . $strHour . $strDate;
      $strClosing = $this->getClosing($profile);
    }
